output_dir='~/Desktop/Figure_paper_to_update/Fig2/Fig2C'
...
URI_Fs = read_tsv('URi_simulation_periodic_1kbXY.tsv')
...
ggsave(plot =Fragiale_sites ,filename = paste0(output_dir,'/Fig2C.pdf'),device = cairo_pdf,width = 17 ,height = 20,units = 'cm')
